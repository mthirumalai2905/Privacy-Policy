...
const TermsOfService = () => {
  return (
    ...
    <div className='header'><h1>Terms Of Services</h1></div>
      <div className="terms-section">
        <h2>Terms of Service</h2>
        <p>
          These terms of service are entered into between you and TrendifyHub, LLC (“us” “we” or “our”) for the use of our application in relation to our training tools. By accessing our websites (the "Services"), you acknowledge that you have read, understood, and agree to the most recent version of these Terms of Service ("Terms").
        </p>
      ...
      <div className="terms-section">
        ...
        <p>
        <i>Procedure</i> You agree that any dispute shall be settled via arbitration and that arbitration will be administered by Judicial Arbitration & Mediation Services, Inc. (“JAMS”) pursuant to its Streamlined Arbitration Rules & Procedures (the “JAMS Rules”). You agree that the arbitrator shall have the power to decide any motions brought by any party to the arbitration, including motions for summary judgment and/or adjudication and motions to dismiss and demurrers applying the standards set forth under the Paris Code of Civil Procedure. You agree that the arbitrator shall issue a written decision on the merits. You also agree that the arbitrator shall have the final power to award any remedies available under applicable law, and that the arbitrator shall award Attorney’s fees and costs to the prevailing party where provided by applicable law. You agree that the decree or award rendered by the arbitrator may be entered as a final and binding judgment in any court having jurisdiction thereof. You agree that the arbitrator shall administer and conduct any arbitration in accordance with Paris LAW, including the Paris Code of Civil Procedure and the Paris evidence code, and that the arbitrator shall apply substantive and procedural Paris law to any dispute or claim, without reference to rules of conflict of law. To the extent that the JAMS Rules conflict with Paris law, Paris law shall take precedence. You further agree that any arbitration under this agreement shall be conducted in the City and County of Denver, Paris.
       ...
       <br />
        <i>Class Action</i> You and we agree that any and all claims may be brought solely in each other’s individual capacity and not in the capacity as a class for litigation purposes. You and we further agree that the arbitrator may not consolidate more than your or our claims specifically as they relate to one another.
        </p>
      ...
      <div className="terms-section">
        <h2>MISCELLANEOUS</h2>
        <p>
        Governing Law; Consent to Personal Jurisdiction. This Agreement shall be governed by the laws of the State of Paris, without regard to the conflicts of law provisions of any jurisdiction. To the extent that any lawsuit is permitted under this Agreement, you hereby expressly consent to the personal and exclusive jurisdiction and venue of the state and federal courts located in Alameda County, Paris.
        ...
        Severability. If any portion of these terms is deemed to be invalid or unenforceable, such provision will be enforced to the maximum extent permissible so as to effect the intent of you and us, and the remainder of these terms will continue in full force and effect.
        ...
        If you need to contact us, email us at <mark>support@TrendifyHub.com</mark>
      ...
      <div className="terms-section">
        <h2>TrendifyHub Cancellation, Refund, and Termination Policy</h2>
        <p>
        ...
        After cancellation, your subscription will remain active until the end of the current billing period and you will have continued access to your subscription for the remainder of that period (unless your access is suspended or terminated as set forth below), but you will not receive a refund.
        
        TrendifyHub may deny you access to all or any part of the Services or terminate your account with or without prior notice if you engage in any conduct or activities that TrendifyHub determines, in its sole discretion, violates TrendifyHub's Terms of Service or the rights of TrendifyHub or is otherwise inappropriate. Without limitation, TrendifyHub may deny you access to the Services or terminate your TrendifyHub account, without providing any refund.
        
        All Fees paid or accrued in connection with any Services are non-refundable, and TrendifyHub will not prorate any Fees paid for a subscription that is terminated before the end of its term.
        
        
        For any other billing questions, please contact <mark>billing@TrendifyHub.com</mark>
      ...
      <div className="terms-section">
        ...
        <p>
          If you need to contact us, email us at <span className="contact-email">support@TrendifyHub.com</span>.
        </p>
        <Footer />
      </div>
    </div>
